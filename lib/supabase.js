 ...
 * @param {boolean} [userData.skipProfile] - Skip users table upsert when true
 * @returns {Promise<Object>}
 */
export async function signUpUser(userData) {
  try {
    // 1. Create auth user
    console.log('[SUPABASE] Creating auth user:', userData.email);
    ...
    let profile = null;
    if (!userData.skipProfile) {
      console.log('[SUPABASE] Upserting user profile...');
      ...
      console.log('[SUPABASE] Skipping profile upsert');
    }
    ...
    console.error('[SUPABASE] signUpUser caught error:', error);
